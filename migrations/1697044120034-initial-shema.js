...
module.exports = class initialShema1697044120034 {
    name = 'initialShema1697044120034'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "worker_report" ("report_id" SERIAL NOT NULL, "worker_id" integer NOT NULL, "car_id" integer NOT NULL, "service_id" integer NOT NULL, CONSTRAINT "REL_c60d76bc0db998d77fc5eae93d" UNIQUE ("car_id"), CONSTRAINT "PK_5a568f6f9fc90b98b8ada27105e" PRIMARY KEY ("report_id"))`);
        await queryRunner.query(`CREATE TABLE "masini" ("car_id" SERIAL NOT NULL, "client_id" integer NOT NULL DEFAULT '0', "model" character varying NOT NULL, "registration_number" character varying NOT NULL, "vin_code" character varying NOT NULL, "culoare" character varying NOT NULL, "km" integer NOT NULL, CONSTRAINT "REL_0be5138be728c8878f54c84d2d" UNIQUE ("car_id"), CONSTRAINT "PK_0be5138be728c8878f54c84d2d1" PRIMARY KEY ("car_id"))`);
