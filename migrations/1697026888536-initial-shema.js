...
module.exports = class initialShema1697026888536 {
    name = 'initialShema1697026888536'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "worker" ("worker_id" SERIAL NOT NULL, "worker_name" character varying NOT NULL, "worker_surname" character varying NOT NULL, "password" character varying NOT NULL, "role_id" integer NOT NULL, CONSTRAINT "PK_ad2a529948e7e73bd6ad7b36a80" PRIMARY KEY ("worker_id"))`);
