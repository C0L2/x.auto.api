...
module.exports = class initialShema1697200140024 {
    name = 'initialShema1697200140024'
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "worker_report" ADD CONSTRAINT "FK_c60d76bc0db998d77fc5eae93d1" FOREIGN KEY ("car_id") REFERENCES "masini"("car_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "masini" ADD CONSTRAINT "FK_0be5138be728c8878f54c84d2d1" FOREIGN KEY ("car_id") REFERENCES "worker_report"("report_id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
}
