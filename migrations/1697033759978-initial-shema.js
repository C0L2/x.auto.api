...
module.exports = class initialShema1697033759978 {
    name = 'initialShema1697033759978'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "programari" ("programare_id" SERIAL NOT NULL, "programare_nume" character varying NOT NULL, "registr_date" TIMESTAMP NOT NULL, CONSTRAINT "PK_5c3ae2542973b386ca5ba20c8ff" PRIMARY KEY ("programare_id"))`);
