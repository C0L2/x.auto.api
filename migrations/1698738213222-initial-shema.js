...
module.exports = class initialShema1698738213222 {
    name = 'initialShema1698738213222'
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "services" ("service_id" SERIAL NOT NULL, "service_name" character varying NOT NULL, "reportReportId" integer, CONSTRAINT "PK_ef0531b9789b488593690ab8d5d" PRIMARY KEY ("service_id"))`);
