...
module.exports = class initialShema1698847939532 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "assigned_services" ("assigned_service_id" SERIAL NOT NULL, "report_id" integer NOT NULL, "service_id" integer NOT NULL, "price" integer, CONSTRAINT "PK_0601500dab09ac34b244ffc8aae" PRIMARY KEY ("assigned_service_id"))`);
